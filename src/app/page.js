...
const HomePage = () => {
  ...
  <div className="absolute inset-0 z-0">
    <Image src="/1.gif" layout="fill" objectFit="cover" alt="Background" />
      ...
      <section className="bg-white flex justify-center items-center text-black relative section-container" style={{ width: '1728px' }}>
        <div>
      ...
      <section style={{ width: '1728px', height: '1000px' }} className="bg-white flex justify-center items-center text-black relative section-container">
        <div>
      ...
      <footer className="bg-black text-white py-9 relative rounded-t-2xl" style={{ width: '1728px' }}>
  <div className="absolute top-0 left-3 pt-4 pl-4">
