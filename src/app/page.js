...
const HomePage = () => {
  return (
    <div className="scroll-container">
      <section className="bg-center flex justify-center items-center text-white relative section-container" style={{ width: '1450px' }}>
  <div className="absolute inset-0 z-0">
    <Image src="/1.gif" layout="fill" objectFit="cover" alt="Background" />
      ...
      <section className="bg-white flex justify-center items-center text-black relative section-container" style={{ width: '1450px' }}>
        <div>
      ...
      <section style={{ width: '1450px', height: '1000px' }} className="bg-white flex justify-center items-center text-black relative section-container">
        <div>
      ...
      <footer className="bg-black text-white py-9 relative rounded-t-2xl" style={{ width: '1450px' }}>
  <div className="absolute top-0 left-3 pt-4 pl-4">
